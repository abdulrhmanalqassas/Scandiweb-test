    ...
    return (
      <div key={this.props.product.name + Math.random()}>
        ...
        {this.props.parent === "Cart" && (
          <h1 className={mini ? "mini-attribute" : "attribute"}>
        ...
        {this.props.product.attributes.map((attribute) => {
          return (
            <div key={attribute.name}>
              <h1 className={mini ? "mini-attribute mini-brand" : "attribute"}>
                {" "}
                {attribute.name} :
              </h1>
              <div style={{ display: "block" }}>
                <fieldset
                  className={mini ? "mini-swatch-picker" : "swatch-picker"}
                >
